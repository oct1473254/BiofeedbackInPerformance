...
MODEM_UID = 11101 # enter your modem unique ID
...
def visualize_countdown():
    ser = serial.Serial("/dev/tty.usbmodem11101", baudrate=115200) # Replace with the correct serial port and baudrate
    ...
    while True:
        ...
        if is_convertible_to_integer(countdown_parameter):
            ...
            filled_percentage = round((countdown / 1000) * 100) # 1000 is the starting heart beat count
            while countdown > 0:
                os.system('clear')
        ...
        logging.info(countdown_parameter)
